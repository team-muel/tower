...
{
    // T59: how the enemy's world body is built. Primitive keeps the legacy
    // single-primitive body; Pillbug composes the segmented parasite body.
    public enum EnemyBodyStyle
    {
        Primitive,
        Pillbug
    }
    ...
    public sealed class EnemyCombatProfile : ScriptableObject
    {
        ...
        [SerializeField] private EnemyBodyStyle bodyStyle = EnemyBodyStyle.Primitive;
        ...
        public EnemyBodyStyle BodyStyle => bodyStyle;
